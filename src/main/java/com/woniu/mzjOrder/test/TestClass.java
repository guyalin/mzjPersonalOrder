package com.woniu.mzjOrder.test;

import com.xiaoleilu.hutool.script.ScriptUtil;
...
public class TestClass {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String enStr = "2019年12月から厳罰化！運転中のながらスマホ";
        GoogTrans g = GoogTrans.getInstance();
        System.out.println(g.translateText(enStr, "auto", "zh_cn"));
